...
def main(argv):
    ...
    print(fountain.combine(
        fountain.backlight_clockwise(2326274, (7, 2), 3, 19, Color.red),
        fountain.valves_counter_clockwise(86543, (7, 2), 3, 19),
        fountain.valves_clockwise(123367, (9, 6), 14, 2)
    ))
